...
with app.app_context():
    ...
    modules = [
        ...
        ('calidad', 'Calidad'),
        ('mapa', 'Mapa'),
        ('plantillas_estaciones', 'Plantillas Estaciones'),
        ('entregas', 'Entregas'),
        ('facturacion_registros', 'Facturación Registros'),
        ('almacen_registros', 'Almacén Registros'),
        ('claves', 'Claves'),
        ('productos', 'Productos'),
        ('componentes', 'Componentes'),
        ('procesos_catalogo', 'Procesos Catálogo'),
        ('historial_precios', 'Historial Precios'),
        ...
        ('perfil', 'Perfil'),
        ('bitacora', 'Bitácora'),
        ('settings_app', 'Configuración App'),
        ...
        ('dashboard_user', 'Dashboard Usuario'),
        ('dashboard_support', 'Dashboard Soporte'),
        ('dashboard_reports', 'Dashboard Reportes'),
        ('dashboard_settings', 'Dashboard Configuración'),
